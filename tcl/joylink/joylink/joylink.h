...
#if  IAR
#define mico_time() time(NULL)
#else
extern unsigned int get_Tcl_UTC();
//#define mico_time mico_get_time
#define mico_time  get_Tcl_UTC
	#endif
