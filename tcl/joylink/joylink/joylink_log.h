...
#define log_info(format, ...) custom_log("joylink", format, ##__VA_ARGS__)

#define log_error(format, ...) custom_log("joylink", format, ##__VA_ARGS__)
...
#define log_debug(format, ...) custom_log("joylink", format, ##__VA_ARGS__)
